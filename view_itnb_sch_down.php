...
<body class="container">
    ...
    <br>
    <a href="rooms/itnb_room/itnb_room_down.php" class="btn bg-secondary border-3 border-secondary-subtle mt-3 fw-bold text-light" style="border-radius: 20px; width: 100px;">back</a>
    <br>
