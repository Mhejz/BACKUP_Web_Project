...
function showSweetAlert(roomName) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        html:
            ...
            '<button class="btn btn-secondary" onclick="viewSchedule(\'' + roomName + '\')">View Schedule</button>',
        onClose: () => {
...
function viewSchedule(roomName) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = '../../view_schedule.php?room=' + encodeURIComponent(roomName);
        }
    });
}
